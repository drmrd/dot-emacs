...
** Appearance
#+src_name org-mode/always-enable-org-indent-mode
...
#+END_SRC
* Easily Add Headers to New Files
#+begin_src emacs-lisp
  (define-skeleton
    org-headers-default
    "Standard headers for a new Org file."
    "Title " "#+TITLE: " str "\n"
    "#+AUTHOR: " user-full-name "\n"
    "#+EMAIL: " user-mail-address "\n"
    "#+DATE: " (format-time-string "%Y-%m-%d") "\n\n")

  (global-set-key [C-S-f1] 'org-headers-default)
#+end_src
...
#+SRC_NAME ox-gfm_enable_github_markdown_export
#+BEGIN_SRC emacs-lisp
...
* TODO (Disabled) Org Ref
Update (2025-06-11): I'm switching from using org-ref to the built-in org-cite
module for the time being. This also circumvents an issue loading helm-related
code in org-ref.
